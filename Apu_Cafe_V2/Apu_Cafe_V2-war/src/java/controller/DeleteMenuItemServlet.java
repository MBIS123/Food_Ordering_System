 ...
 * @author User
 */
@WebServlet(name = "DeleteMenuItemServlet", urlPatterns = {"/DeleteMenuItemServlet"})
public class DeleteMenuItemServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            System.out.println("Enter DeleteMenuServlet");

            String itemId = request.getParameter("itemId");
            menuFacade.deleteMenuById(Long.parseLong(itemId));
