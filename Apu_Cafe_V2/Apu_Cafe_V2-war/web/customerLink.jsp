...
<html>
    ...
    * {
    ...
    <body>
        ...
        <nav>
            <ul>
                <li><a href="LoadCustomerManageServlet?action=backHome">Home</a></li>
                <li><a href="LoadCustomerManageServlet?action=profile">Profile</a></li>
                <li><a href="LoadCustomerManageServlet?action=viewOrder">View Order</a></li>
