...
<html>
    <head>
        ...
        <title>Staff Staff Home Page</title>
...
<body>
    <div class="container">
        ...
        <div class="top-bar">
            <input type="text" id="searchInput" onkeyup="searchMenu()" placeholder="Search Order by Id ">
        </div>
        <h2>Pending Order</h2>
        <table id="orderTable">
            <tr>
        ...
        <tr data-name="<%= order.getId()%>">
            ...
            <td>RM<%= order.getMenuItem().getPrice()%></td>
            <td>
                <form action="ManageStallStaffServlet" method="post" onsubmit="return confirmCollect();" >
                    <input type="hidden" name="orderId" value="<%= order.getId()%>">
                    <input type="hidden" name="manageType" value="editOrDelete">
                    <button type="submit" class="edit-btn" name="action" value="collectPayment">Collect Payment</button>
                </form>
            </td>
        </tr>
        <%
